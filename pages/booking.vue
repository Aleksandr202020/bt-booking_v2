<template>
  <section>
    ...
    <div class="card">
      <div class="actions" style="justify-content:space-between"><h2 style="margin:0">Laiks</h2><span class="muted">09:00–21:00</span></div>
...
const cars=ref<any[]>([]);const slots=ref<any[]>([]);const carId=ref('');const selectedTime=ref('');const saving=ref(false);const error=ref('');const date=ref(new Date().toISOString().slice(0,10));const today=date.value
